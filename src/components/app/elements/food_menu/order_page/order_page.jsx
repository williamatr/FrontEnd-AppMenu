  ...
  return (
    <div className="page_order_1">
      ...
      <div className="list_order">
        {orderList.map(p => (
          <div className="container_product_order" key={p.product.id}>
            <button type="button" className="collapsible_info_order">
              ...
              <li className="name_item"> {p.product.name} </li>
              <li className="price_item"> ${formatNumber(p.value)}</li>
