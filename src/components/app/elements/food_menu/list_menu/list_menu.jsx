                ...
                >
                  <div className="card_list">
                    <div className="order_card">
                      ...
                      <div className="text">
                        <div className="order_text_list_menu">
                          <div className="title_list_menu">
                            {d.product.name}
                          </div>
                          <div className="description_list_menu">
                            {d.product.description}
                          </div>
                          <div className="cost_list_menu">
      ...
      return (
        <div>
          ...
          <div className="register_fav">
            <button className="button_register_fav" type="button">
        ...
        >
          <div className="card_list">
            <div className="order_card">
              ...
              <div className="text">
                <div className="order_text_list_menu">
                  <div className="title_list_menu">{d.product.name}</div>
                  <div className="description_list_menu">
                    {d.product.description}
                  </div>
                  <div className="cost_list_menu">
